...
restart_quiz.onclick = ()=>{
    ...
    timeOff.textContent = "Sisa Waktu";
}
...
function showResultBox(){
    ...
    if(userScore > 3){
        let scoreTag = "<span>Selamat! Kamu dapat skor <p>"+ userScore +"</p> dari <p>"+ questions.length +"</p> soal!</span>";
        scoreText.innerHTML = scoreTag;
    } else if(userScore > 1){
        let scoreTag = "<span>Lumayan, kamu dapat skor <p>"+ userScore +"</p> dari <p>"+ questions.length +"</p> soal</span>";
        scoreText.innerHTML = scoreTag;
    } else {
        let scoreTag = "<span>Maaf ya, kamu cuma dapat skor <p>"+ userScore +"</p> dari <p>"+ questions.length +"</p> soal</span>";
        scoreText.innerHTML = scoreTag;
    }
}
...
let tickIcon = '<div class="icon tick"><i class="bx bx-check-circle"></i></div>';
let crossIcon = '<div class="icon cross"><i class="bx bx-x-circle"></i></div>';
...
function startTimer(time){
    ...
    function timer(){
        ...
        if(time < 0){
            ...
            timeOff.textContent = "Waktu Habis";
